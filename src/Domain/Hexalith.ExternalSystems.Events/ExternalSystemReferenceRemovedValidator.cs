...
namespace Hexalith.ExternalSystems.Events;

using FluentValidation;

/// <summary>
/// Class ExternalSystemReferenceRemovedValidator.
/// Implements the <see cref="AbstractValidator{ExternalSystemReferenceRemoved}" />.
/// </summary>
/// <seealso cref="AbstractValidator{ExternalSystemReferenceRemoved}" />
